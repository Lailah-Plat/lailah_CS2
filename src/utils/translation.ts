...
export const TRANSLATIONS: Record<'ar' | 'en', Record<string, string>> = {
  ar: {
    // Sidebar Tabs
    'overview': 'مركز القيادة والعمليات',
    'cockpit': 'مركز القيادة والعمليات الموحد',
    'bookings': 'مركز الحجوزات والطلبات',
    'halls': 'إدارة الأماكن والقاعات',
    'services': 'مركز الخدمات واللوجستيات',
    'inventory': 'إدارة الأصول والمخزون',
    'suppliers': 'إدارة الموردين والإمداد',
    'subscriptions': 'مركز الباقات والاشتراكات',
    'finance': 'المركز المالي والخزينة',
    ...
    'support': 'مركز الدعم والمساندة',
    'reviews': 'مركز الجودة والتقييمات',
    'messages': 'مركز المراسلة والبريد',
    'diagnostics': 'الفحص والاختبارات الذاتية',
    'settings': 'الإعدادات والربط السيادي',
