...
export const eventServices: EventService[] = [
  { id: 1, name: 'بوفيه مفتوح ملكي (VIP)', category: 'بوفيه وضيافة', city: 'الرياض', price: 350, description: 'بوفيه فاخر يشمل جميع الأصناف والمقبلات والمأكولات البحرية والمشويات بتقديم فندقي مميز لحفلات الزفاف والمناسبات', terms: 'الحجز المسبق قبل 48 ساعة\nدفع عربون 50%', quantityLimit: '', rating: 4.9, image: 'https://images.unsplash.com/photo-1555244162-803834f70033?w=800&auto=format&fit=crop&q=80', provider: 'شركة أطياف لتنظيم المعارض والضيافة', regions: 'الرياض، مكة المكرمة، المنطقة الشرقية', cities: 'الرياض، جدة، الدمام' },
  { id: 2, name: 'توثيق وتصوير سينمائي 4K', category: 'تصوير', city: 'الرياض', price: 5000, description: 'تغطية كاملة للمناسبة بطاقم مصورين احترافي وكاميرات سينمائية وطائرات درون مع ألبوم فاخر وفيديو تشويقي', terms: 'دفع كامل المبلغ قبل المناسبة', quantityLimit: '5', rating: 4.8, image: 'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=800&auto=format&fit=crop&q=80', provider: 'استوديو روتانا الفوتوغرافي', regions: 'الرياض، المنطقة الشرقية', cities: 'الرياض، الدمام، الخبر' },
  { id: 3, name: 'كوش وتنسيق زهور طبيعية', category: 'تنسيق قاعات', city: 'مكة المكرمة', price: 3500, description: 'تصميم وتنفيذ كوشة العروس وممرات الزفة وطاولات الضيوف بأرقى أنواع الزهور الطبيعية والإضاءة الهادئة', terms: 'لا يتم إرجاع العربون عند الإلغاء قبل أسبوع', quantityLimit: '', rating: 4.9, image: 'https://images.unsplash.com/photo-1519225421980-715cb0215aed?w=800&auto=format&fit=crop&q=80', provider: 'شركة كوش الفخمة وتنسيق الأفراح', regions: 'مكة المكرمة، الرياض', cities: 'مكة المكرمة، جدة، الرياض' },
  { id: 4, name: 'فرقة موسيقية وهندسة صوتية', category: 'دي جي وفِرق', city: 'جدة', price: 4500, description: 'إحياء مناسبتك بأفضل الفرق الغنائية وأحدث أجهزة الدي جي والمكسرات الصوتية المجهزة بأعلى المعايير', terms: 'توفير مسرح مجهز ومنفذ كهرباء ملائم', quantityLimit: '1', rating: 4.7, image: 'https://images.unsplash.com/photo-1470229722913-7c090be5f524?w=800&auto=format&fit=crop&q=80', provider: 'فرقة الألحان الذهبية', regions: 'مكة المكرمة، الرياض', cities: 'جدة، الرياض' },
  { id: 5, name: 'خدمة القهوة السعودية والضيافة والعطور', category: 'بوفيه وضيافة', city: 'الرياض', price: 1800, description: 'مباشرين ومباشرات بزي سعودي تراثي فاخر لتقديم القهوة السعودية، الشاي، التمور المحشوة، وطيب العود والعطورات الفاخرة', terms: 'يشمل طاقم خدمة متكامل مدرب', quantityLimit: '', rating: 5.0, image: 'https://images.unsplash.com/photo-1544025162-d76694265947?w=800&auto=format&fit=crop&q=80', provider: 'صالون الأناقة للضيافة والتمثيل', regions: 'الرياض، القصيم', cities: 'الرياض، بريدة' },
  { id: 6, name: 'إضاءة ليزرية ومؤثرات دخان وشرار بارد', category: 'إضاءة ومؤثرات', city: 'الرياض', price: 2200, description: 'شبكة إضاءة متطورة ومتحركة للمسرح ورقصة العرسان مع أجهزة شرار بارد ودخان كثيف آمن', terms: 'التركيب قبل المناسبة بـ 3 ساعات', quantityLimit: '', rating: 4.8, image: 'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=800&auto=format&fit=crop&q=80', provider: 'شركة لمسات لتنظيم المؤتمرات', regions: 'الرياض، الشرقية', cities: 'الرياض، الدمام' },
  { id: 7, name: 'طاقم أمن واستقبال وتنظيم عبايات', category: 'تنظيم وأمن', city: 'الرياض', price: 1500, description: 'طاقم أمني نسائي ورجالي محترف لإدارة بوابات الدخول، تنظيم مواقف السيارات، واستلام وتسليم العبايات بنظام مرقم', terms: 'طاقم مرخص ومدرّب على التعامل الراقي', quantityLimit: '', rating: 4.9, image: 'https://images.unsplash.com/photo-1475721027785-f74eccf877e2?w=800&auto=format&fit=crop&q=80', provider: 'مؤسسة ليلة لخدمات المناسبات', regions: 'الرياض، جدة، الدمام', cities: 'الرياض، جدة، الدمام' }
];
